...
import com.morefans.mfs_nacos_demo.service.RestService;
import com.morefans.mfs_nacos_demo.service.UserService;
...
@EnableScheduling
@EnableCaching
public class MfsNacosDemoConsumerApplication {
...
//    }
    ...
    public static void main(String[] args) {
        new SpringApplicationBuilder(MfsNacosDemoConsumerApplication.class)
    ...
    public interface FeignRestService {
        ...
        @PostMapping(value = "/request/body/map", produces = ContentType.APPLICATION_JSON_UTF_8)
